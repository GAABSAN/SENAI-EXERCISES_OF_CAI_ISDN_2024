...
while True:
  codigo = int(input("Digite o código do produto que desejar (ou 0 para encerrar a lista): "))

  if codigo == 0:
    break

  if codigo < 100 or codigo > 105:
    print("Código Ínvalido!!! ")
    codigo = int(input("Insira um código valido: "))

  quantidade = int(input("Digite a quantidade do produto desejado: "))

  if codigo == 100:
    preco = 1.20
    quant_p100 += quantidade

  elif codigo == 101:
    preco = 1.30
    quant_p101 += quantidade

  elif codigo == 102:
    preco = 1.50
    quant_p102 += quantidade

  elif codigo == 103:
    preco = 1.20
    quant_p103 += quantidade

  elif codigo == 104:
    preco = 1.30
    quant_p104 += quantidade

  elif codigo == 105:
    preco = 1.00
    quant_p105 += quantidade

  ptotal = preco * quantidade

  print(f"Codigo {codigo} - Quantidade {quantidade} - Preço unidade R${preco:.2f} - Preço Total R${ptotal:.2f}")
...
print("Para sair (0); Para votar nulo (5); Para votar em branco(6).")
...
print("Resultado da Eleição 2030")
print(f"""

Candidatos:
1 - Ronaldinho Gaúcho = {c1} Votos.
2 - Zezo Potiguar     = {c2} Votos.
3 - Diego Maradona    = {c3} Votos.
4 - Cleiton Rasta     = {c4} Votos.

Nulos                 = {nulo} Votos / {100*nulo/votos:.2f}
Brancos               = {branco} Votos / {100*branco/votos:.2f}
""")